...
export default [
    ...
    },
    {
        ...
        "description": "An Android application designed and engineered in Android Studio using Java, SQLite, and xml. Currently available on the Google Play store. WorkoutTracker is a quick and easy way to record each set you perform during your workouts, day by day, to keep track of your progress!",
        "organization": "Self"
    },
    {
        "id": 3,
